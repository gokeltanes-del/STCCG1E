...
Last updated: 2026-09-06 (Data — Anaphasic Organism Premiere tip 502d8e0 partial until Pepsch green)
...
| Anaphasic Organism (12 C) | partial | tip Data/`502d8e0`: Pass MED+SEC Overcome; no female no-effect; fail discard highest female (opp tie) + Stop + discard dilemma. Pending Pepsch green. | Data/`502d8e0` 2026-09-06 |
