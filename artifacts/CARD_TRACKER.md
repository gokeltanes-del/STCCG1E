...
Last updated: 2026-09-15 (Jadzia — Escape Pod tips 7917a30/a3481a1 pending Pepsch green)
...
| Escape Pod (116 C) | partial | tips Data/`5e55eef` + `7917a30`/`a3481a1` (Josef, no push): ShipDestroyed window even during battle stack (Borg EOT); crew/personnel only; window only if crew aboard + Pod in hand. Stays partial until Pepsch greens — not working. | Data/`7917a30`+`a3481a1`+`5e55eef` 2026-09-15 |
