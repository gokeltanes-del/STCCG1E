...
Last updated: 2026-09-18 (Jadzia — Tsiolkovsky tip 98aec60 FirstListedSkill pending Pepsch)
...
| Tsiolkovsky Infection (52 R) | partial | tips Data/`948cf0f` + Foundation/`98aec60` (Josef, no push): FirstListedSkill (skip class echo); Apply+Summary skill-loss (not attributes -3). AttachContinue + Cure 3 MEDICAL + no StopTeam OK. Stays partial until Pepsch greens. | Data/`98aec60` 2026-09-18 |
