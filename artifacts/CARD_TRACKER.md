...
| Kurlan Naiskos (4 R) | working | tip bfe0de9 PersonnelTypePresent Class|Skill|Equipment; tip 70e03f1 S.A.M. (printed+Adds)x3 Battle=UI. Pepsch 2026-09-21 Gesamt gr?n (Typen, Anzeige, Kampf). | Pepsch green |
...
| Archer (14 C) | working | Pepsch green best�tigt: Auswertung Attribute / Opponent-Choice bei Gleichstand und Stop-Verhalten funktionieren einwandfrei. | Pepsch 2026-09-13 |
...
| Hyper-Aging (28 U) | working | Pepsch green Quarant�ne+Beam-Block `46eab15`; Detailansicht Debuff-Gruppierung OK. RemFatigue PARK. | Pepsch 2026-09-12 |
...
| Microvirus (36 C) | working | Pos+neg Choose OK. PARK: UI Dilemma-gro� + 2-Fenster Chooser/Beobachter. | Pepsch 2026-09-07 |
...
| Phased Matter (42 C) | working | Pepsch green: AT-Split, Stasis der gr��eren Gruppe, Weiterf�hrung der kleineren Gruppe und Cure (ENG+SCI unphased) via zentrales Cure-System best�tigt. | Pepsch 2026-09-13 |
| Portal Guard (43 U) | working | CUNN&gt;7/Honor Continue; Fail: BeamBack+Stop wenn Beamen m�glich (Schiff/Facility vorhanden, kein Stasis/Quarant�ne); Kill wenn Beamen unm�glich (z.B. Hyper-Aging Quarant�ne oder kein Schiff/Facility) + unter Mission. Unit-Test `VerifyPortalGuard`. | Captain 2026-09-13 |
...
| Atmospheric Ionization (68 C) | working | tip 4014657 Scope to/from planet only; Pepsch 2026-09-22 Scope gr?n (Ship-Ship/Outpost frei). Offen/geparkt: Freundes-Report ?selected one, beamed everything exceeding limit? ? Pepsch nicht nachvollziehbar, kein Tip. | Pepsch green (Scope) |
...
| Pegasus Search (178 R) | working | tip 5b552d7 OR+{IG} present; tip be7d6a7 Multi-Earn IG zu AT. Pepsch 2026-09-22 IPG Mission l?sen Pegasus Search funktioniert. | Pepsch green |
