...
| Microvirus (36 C) | partial | tip Data/`TBD`. Pass MED+SEC +5 Continue discard; Fail Opp 1 Kill (no Android/Exocomp/Holo)+Stop always discard. Spock #19 Soll. PARK: UI filter thin. Ungetestet. | Data/`TBD` 2026-09-06 |
