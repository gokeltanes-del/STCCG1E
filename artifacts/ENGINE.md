...
**Done 2026-09-04:** `EngineAuthority.FlyLineForPiece` shared with `TryEvaluateFlyPath`; `LegalMoves.AddExecuteOrders` destinations from BoardStore Locations (Printed); `OrderedMissions()` only when line empty.
