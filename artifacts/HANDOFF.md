...
Last updated: 2026-09-18 (Data -- Foundation first-listed skill Classification skip)
...
## Current tip
Local Josef tip **98aec60** - Fix: Foundation first-listed skill skips Classification (all Personnel). Nicht gepusht.
...
Done prior: **Tarellian Plague Ship** Pepsch green (incl. Step0 003f811). Fix-Go tip: **Tsiolkovsky Infection** Foundation first-listed (skip class) + Apply+Summary; Events Positive kept.
